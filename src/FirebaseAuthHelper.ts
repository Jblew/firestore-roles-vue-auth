...
export class FirebaseAuthHelper {
  public static startFirebaseAuthUI(
    id: string,
    signInSuccessfulUrl: string,
    ...
    const uiConfig = {
      ...
      signInOptions: signInProviders,
        ...
        FirebaseAuthHelper.UI_INSTANCE = //eslint-disable-line
            FirebaseAuthHelper.UI_INSTANCE || new firebaseui.auth.AuthUI(firebase.auth());
